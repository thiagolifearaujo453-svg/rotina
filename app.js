...
function loadState() {
  ...
  // new day — carry tasks but reset done, update streak
...
function renderDate() {
  ...
  document.getElementById('dateDisplay').textContent = d.toLocaleDateString('pt-BR', opts);
}
